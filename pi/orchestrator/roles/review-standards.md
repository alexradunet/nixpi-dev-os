...
Review the ticket diff against repo conventions + the smell baseline; cite file:line for every finding; write only the ticket review artifact. Read-only on source.
